...
regex calfrer("^[a-z]*[A-Z][a-z0-9]{1,6}*[.]"); 
regex simber("[.,;:()]{2}");
regex simbariter("['+''-''*'/]{2}");
regex simbreler("[<>=]{2}");
 			...
 			do
				{
					...
					{
					 strcat(digitoe,dato);  
				     strcat(digitoe," Error <digito> incorrecto");
				     strcat(digitoe,"\n");	
					}
					...
					{
					 strcat(letrae,dato);  
				     strcat(letrae," Error <letra> mayuscula");
				     strcat(letrae,"\n");	
					}
					...
					if(regex_match(dato,palabraer))	
					{
				     ...
				     strcat(palabrae," Error <palabra_res> incorrecta");
				     strcat(palabrae,"\n");	
					}
					...
					{
					 strcat(calfe,dato);  
				     strcat(calfe," Error <identificador> incorrecto");
				     strcat(calfe,"\n");	
					}
					...
					{
					 strcat(simbe,dato);  
				     strcat(simbe," Error <especial> incorrecto");
				     strcat(simbe,"\n");	
					}
					...
					{
					 strcat(simbae,dato);  
				     strcat(simbae," Error <o_aritmetico> incorrecto");
				     strcat(simbae,"\n");	
					}
					...
					{
					 strcat(simbree,dato);  
				     strcat(simbree," Error <o_relacion> incorrecto");
				     strcat(simbree,"\n");	
					}
						...
						if(regex_match(dato,funcionMiner))	
					{
				     ...
				     strcat(funcionminee," Error <funcion> incorrecto palabras mayuscula");
				     strcat(funcionminee,"\n");	
					}
						...
						if(regex_match(dato,funcionMayer))	
					{
				     ...
				     strcat(funcionmayee," Error <funcion> incorrecto identificador minuscula");
				     strcat(funcionmayee,"\n");	
						...
						if(regex_match(dato,funcionPer))	
					{
				     ...
				     strcat(funcionpee," Error <funcion> incorrecto todo identificador minusculas ");
				     strcat(funcionpee,"\n");	
					}
